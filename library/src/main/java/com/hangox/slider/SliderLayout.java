...
import com.hangox.slider.Animations.BaseAnimationInterface;
import com.hangox.slider.Indicators.PagerIndicator;

import com.hangox.slider.SliderTypes.SliderHolder;
import com.hangox.slider.Transformers.AccordionTransformer;
import com.hangox.slider.Transformers.BackgroundToForegroundTransformer;
import com.hangox.slider.Transformers.BaseTransformer;
import com.hangox.slider.Transformers.CubeInTransformer;
import com.hangox.slider.Transformers.DefaultTransformer;
import com.hangox.slider.Transformers.DepthPageTransformer;
import com.hangox.slider.Transformers.FadeTransformer;
import com.hangox.slider.Transformers.FlipHorizontalTransformer;
import com.hangox.slider.Transformers.FlipPageViewTransformer;
import com.hangox.slider.Transformers.ForegroundToBackgroundTransformer;
import com.hangox.slider.Transformers.RotateDownTransformer;
import com.hangox.slider.Transformers.RotateUpTransformer;
import com.hangox.slider.Transformers.StackTransformer;
import com.hangox.slider.Transformers.TabletTransformer;
import com.hangox.slider.Transformers.ZoomInTransformer;
import com.hangox.slider.Transformers.ZoomOutSlideTransformer;
import com.hangox.slider.Transformers.ZoomOutTransformer;
import com.hangox.slider.Tricks.FixedSpeedScroller;
import com.hangox.slider.Tricks.InfinitePagerAdapter;
import com.hangox.slider.Tricks.InfiniteViewPager;
import com.hangox.slider.Tricks.ViewPagerEx;
...
/**
 * SliderLayout is compound layout. This is combined with {@link com.hangox.slider.Indicators.PagerIndicator}
 * and {@link com.hangox.slider.Tricks.ViewPagerEx} .
 *
...
public class SliderLayout extends RelativeLayout{
    ...
    /**
     * {@link com.hangox.slider.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link com.hangox.slider.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link com.hangox.slider.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link com.hangox.slider.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link com.hangox.slider.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link com.hangox.slider.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link com.hangox.slider.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link com.hangox.slider.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see com.hangox.slider.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link com.hangox.slider.Indicators.PagerIndicator} shape, rect or oval.
     */
     ...
     * {@link com.hangox.slider.Animations.BaseAnimationInterface},
     * and you can see a example in {@link com.hangox.slider.Animations.DescriptionAnimation}
     * @param animation
     */
    ...
    /**
     * get the {@link com.hangox.slider.Indicators.PagerIndicator} instance.
